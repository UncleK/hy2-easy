<p align="center">
  <img src="assets/banner.svg" alt="hy2-easy — 自己的 VPN，简单连接。安装、导入、连接。" width="100%">
</p>
...
- [安装路径、备份、卸载](operations.md)
- [数据去向与证书校验](security.md)
- [测试方法和已验证范围](verification.md)
- [参与开发](CONTRIBUTING.md)
- [MIT 许可证](LICENSE)

hy2-easy 0.2.0 固定使用 Hysteria 2.12.2，不自动升级上游核心。
