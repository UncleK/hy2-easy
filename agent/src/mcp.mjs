...
const server = new McpServer({name: 'hy2-easy', version: '0.2.1'});
...
server.registerTool('hy2_connection', {description: '安装完成后返回 VPN 链接及二维码图片，展示给用户。不支持图片的 Agent 应保留本机配置页入口。不要把二维码上传公共图床。', inputSchema: {id: z.string().uuid()}, annotations: {readOnlyHint: true}}, call(({id}) => app.connection(id)));
